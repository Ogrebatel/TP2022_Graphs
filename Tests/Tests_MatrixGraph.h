...
#ifndef GRAPHS_TESTS_MATRIXGRAPH_H
#define GRAPHS_TESTS_MATRIXGRAPH_H
...
TEST_F(MatrixGraphTests, VerticesCount){
    EXPECT_EQ(graph.VerticesCount(), 7);
}

TEST_F(MatrixGraphTests, GetNextVertices0){
...
TEST_F(MatrixGraphTests, GetNextVertices1){
...
TEST_F(MatrixGraphTests, GetNextVertices3){
...
TEST_F(MatrixGraphTests, GetNextVertices5){
...
TEST_F(MatrixGraphTests, GetNextVertices6){
...
TEST_F(MatrixGraphTests, GetPrevVertices1){
...
TEST_F(MatrixGraphTests, GetPrevVertices2){
...
TEST_F(MatrixGraphTests, GetPrevVertices3){
...
TEST_F(MatrixGraphTests, GetPrevVertices4){
...
TEST_F(MatrixGraphTests, GetPrevVertices5){
...
TEST_F(MatrixGraphTests, GetPrevVertices6){
...
#endif //GRAPHS_TESTS_MATRIXGRAPH_H
